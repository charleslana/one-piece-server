...
export class SocketRoomService {
  ...
  public getLastUserExcept(roomId: string, excludedUserId: string): UserInterface | undefined {
    const room = this.getRoom(roomId);
    if (room) {
  ...
  public updateUserWatchInRoom(roomId: string, userId: string, watch: boolean): void {
    const room = this.getRoom(roomId);
    if (room) {
